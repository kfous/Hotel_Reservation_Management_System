...
public class SearchReservationName extends JFrame implements ActionListener {
    ...
    public SearchReservationName(ObjectOutputStream out) {
        super("Αναζήτηση με βάση το όνομα κράτησης");
        this.out = out;
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setVisible(true);
        label1 = new JLabel("Όνομα κράτησης: ");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //Περίπτωση αναζήτησης κράτησης με βάση το όνομα
        if (obj == searchRes) {
            //χρήση αντικειμένου ξενοδοχείου για την υλοποίηση απαραίτητης μεθόδου έυρεσης κράτησης
            JOptionPane.showMessageDialog(null,(h1.search_Reservation_Name(txt1.getText()).toString()));
